          ...
          <table className="min-w-full bg-white border border-gray-200 rounded-lg">
            <thead>
              <tr>
                ...
                <th className="px-4 py-2 border-b text-left text-sm font-semibold text-gray-700">Credential Name</th>
                <th className="px-4 py-2 border-b text-left text-sm font-semibold text-gray-700">Type</th>
                <th className="px-4 py-2 border-b text-left text-sm font-semibold text-gray-700">Issuer</th>
              </tr>
            </thead>
            <tbody>
              {vcs.map((vc) => (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <span className="text-blue-700">
                {selectedVcs.length} credential{selectedVcs.length !== 1 ? 's' : ''} selected
              </span>
            </div>
            <button
              onClick={() => setSelectedVcs([])}
